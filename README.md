About uncertainty-toolbox-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/uncertainty-toolbox-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/uncertainty-toolbox-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add uncertainty-toolbox
# for installing globally
pixi global install uncertainty-toolbox
```
...
It is possible to list all of the versions of `uncertainty-toolbox` available on your platform:
...
```
pixi search uncertainty-toolbox --channel conda-forge
```
